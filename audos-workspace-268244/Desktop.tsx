...
const baseIconMap: Record<string, ComponentType<any>> = {
  ...
  AtSign, DollarSign, Percent, Calculator, Cable, Code, Terminal, Database, Server,
      ...
      <div className="hidden md:block py-16 min-h-screen">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 max-w-4xl">
              ...
              {mode === 'entrepreneur' && (
                <button
                  ...
                  className="group flex flex-col items-center p-6 bg-[var(--space-surface-panel)] backdrop-blur-md rounded-2xl border border-[var(--space-border-default)] shadow-[0_14px_34px_#b3e5ff] hover:bg-[var(--space-surface-panel-strong)] hover:shadow-[0_18px_44px_#8fd8ff] hover:scale-105 transition-all duration-300 cursor-pointer"
                >
                  <div className="w-16 h-16 flex items-center justify-center bg-[var(--space-surface-accent-soft)] rounded-2xl mb-4 group-hover:brightness-95 transition-colors">
            ...
            <div className="fixed bottom-8 left-1/2 -translate-x-1/2 w-full max-w-2xl px-6">
              <div className="flex flex-col items-center gap-3">
                ...
                <button
                  ...
                  className={`p-3 ${tw.agent.fab} rounded-full shadow-[0_14px_34px_#b3e5ff] hover:shadow-[0_18px_44px_#8fd8ff] hover:scale-110 active:scale-95 transition-all duration-300 ease-out`}
                ...
                <form
                  ...
                  className="w-full flex items-center gap-3 px-5 py-3 bg-[var(--space-surface-panel-strong)] backdrop-blur-md rounded-2xl border border-[var(--space-border-default)] shadow-[0_18px_44px_#8fd8ff] hover:shadow-[0_22px_56px_#8fd8ff] hover:brightness-95 transition-all duration-300"
                >
        ...
        <div className="flex items-center justify-center gap-6 px-6 overflow-hidden">
          ...
          {activeWindowId && activeWindowId !== 'agent' && (
            ...
            >
              <div className="w-full h-full flex flex-col bg-[var(--space-surface-card)] rounded-2xl shadow-[0_22px_56px_#8fd8ff] overflow-hidden">
                {/* App Header */}
        ...
        {isAgentMinimized && (
          <button
            ...
            className={`fixed bottom-8 right-8 flex items-center gap-2 px-4 py-3 ${tw.agent.fab} rounded-full shadow-[0_14px_34px_#b3e5ff] transition-all hover:scale-105 z-50`}
          >
